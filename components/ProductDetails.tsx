...
const ProductDetails: React.FC<ProductDetailsProps> = ({ id }) => {
  const [pageInitialized, setPageInitialized] = useState<boolean>();
  ...
  if (!pageInitialized || loading) return <LoadingState />;
  ...
  return (
    <div className="max-w-screen-2xl w-full mx-auto bg-white py-4 px-4 md:px-10 lg:px-3">
      <div className="flex flex-col md:flex-row justify-evenly gap-6">
        <div className="w-full lg:w-[60%] flex flex-col gap-4">
          <div className="relative border-[4px] border-green-600 rounded-lg h-[280px] lg:h-[450px] w-full">
            <Image
              src={displayedImage}
              alt={name || "Product"}
              fill
        ...
        <div className="w-full lg:w-[35rem] px-[1rem] lg:px-[2rem] py-6 lg:border-2 border-slate-200 rounded-md">
