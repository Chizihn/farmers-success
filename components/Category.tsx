...
const Category = () => {
  ...
  return (
    <div>
      <div className="bg-white hidden p-3 lg:p-4 shadow-sm rounded-md lg:flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-4 lg:gap-2">
